...
while end_date > start_date:
    ...
    ohlcv = exchange.fetch_ohlcv(symbol, timeframe, since=int(start_date.timestamp()) * 1000, limit=1000)  # Limit per request is 1000 candles
...
prediction = (prediction * std_prediction) + mean_prediction
